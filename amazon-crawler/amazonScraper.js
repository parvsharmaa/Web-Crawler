...
// } from './config/singletonDB.js';

/**
 * Function to scrape Amazon search results and store data in MongoDB.
 * @param {Page} page - Puppeteer page object.
 * @param {string} searchPhrase - The search phrase to use on Amazon.
 * @param {number} scrapeToPage - The page to scrape up to.
 */
async function scrapeAmazon(page, searchPhrase, scrapeToPage) {
  try {
    ...
    /**
     * Recursive function to scrape each page of search results.
     * @param {string} url - The URL of the page to scrape.
     * @param {number} currentPage - The current page being scraped.
     * @param {number} scrapeToPage - The page to scrape up to.
     */
    ...
    // await storeDataInMongoDB(cardData);
...
// Export the scrapeAmazon function
